...
const TREATMENT_IMAGES = {
  // Neurotoxins & Fillers
  neurotoxins: '/fillers.png',
  botox: '/fillers.png',
  dysport: '/fillers.png',
  xeomin: '/fillers.png',
  jeuveau: '/fillers.png',
  'dermal-filler': '/fillers.png',
  sculptra: '/fillers.png',
  'hyper-diluted-radiesse': '/fillers.png',
  'prp-therapy': '/fillers.png',
  'signature-cheeks': '/fillers.png',
  'signature-lips': '/fillers.png',
  'under-eye-filler': '/fillers.png',
  'hand-rejuvenation': '/fillers.png',
  renuva: '/fillers.png',
  'lip-plump': '/fillers.png',
  'lip-pop': '/fillers.png',
  // Skin & Body
  'facials-and-peels': '/bodyskin.png',
  facials: '/bodyskin.png',
  'chemical-peels': '/bodyskin.png',
  microneedling: '/bodyskin.png',
  'pdo-threads': '/bodyskin.png',
  coolsculpting: '/bodyskin.png',
  sclerotherapy: '/bodyskin.png',
  'diamond-glow': '/bodyskin.png',
  'european-facial': '/bodyskin.png',
  'hydrating-facial': '/bodyskin.png',
  'signature-facial': '/bodyskin.png',
  'express-facial': '/bodyskin.png',
  'acne-facial': '/bodyskin.png',
  'dermaplane-facial': '/bodyskin.png',
  dermaplaning: '/bodyskin.png',
  'age-defying-peel': '/bodyskin.png',
  'clear-enhanced-peel': '/bodyskin.png',
  'vitamin-a-peel': '/bodyskin.png',
  'acne-power-treatment': '/bodyskin.png',
  'tca-peel': '/bodyskin.png',
  'hydro-jelly-addon': '/bodyskin.png',
  'led-addon': '/bodyskin.png',
  'jelly-mask-addon': '/bodyskin.png',
  'dermaplaning-addon': '/bodyskin.png',
  'acne-jelly-mask': '/bodyskin.png',
  'gogi-antioxidant-mask': '/bodyskin.png',
  'brightening-jelly-mask': '/bodyskin.png',
  // Laser & Aesthetics
  'ipl-photofacial': '/laser.png',
  'co2-laser': '/laser.png',
  'laser-hair-removal': '/laser.png',
  'acne-scar-treatment': '/laser.png',
  'acne-scar-removal': '/laser.png',
  'age-spot-removal': '/laser.png',
  'vampire-facial': '/laser.png',
  'vampire-facelift': '/laser.png',
  'co2-lite': '/laser.png',
  'profound-acne-scars': '/laser.png',
  // Women's Health
  clitoxin: '/womenhealth.png',
  femilift: '/womenhealth.png',
  'o-shot': '/womenhealth.png',
  'v-plump': '/womenhealth.png',
  'vampire-breast-lift': '/womenhealth.png',
  'womens-hormone-replacement': '/womenhealth.png',
  'pap-smear': '/womenhealth.png',
  // Men's Health
  'p-shot': '/menhealth.png',
  'p-toxin': '/menhealth.png',
  'ed-trifecta': '/menhealth.png',
  'shockwave-therapy': '/menhealth.png',
  'mens-hormone-replacement': '/menhealth.png',
  // Wellness & Medical
  'b12-shots': '/medical.png',
  'iv-therapy': '/medical.png',
  'medical-weight-loss': '/medical.png',
  'medical-exam': '/medical.png',
  'medical-dermatology': '/medical.png',
  'medical-cannabis': '/medical.png',
  'iv-energy': '/medical.png',
  'iv-well': '/medical.png',
  'iv-inner-beauty': '/medical.png',
  'iv-quench': '/medical.png',
  'mic-injections': '/medical.png',
}
